/**
    This contract uses multisig functionality to make transactions between users who don't trust each other.
 */

// SPDX-License-Identifier: none
pragma solidity ^0.8.10;

contract MultisigTransactions {
    ...
    modifier onlyOwner() {
        require(isOwner[msg.sender], "Only owner can call the function");
        _;
    }
    ...
    constructor(address[] memory _owners, uint _numConfirmationsRequired) {
        require(_owners.length > 0, "Number of owners cannot be zero");
